...
export const HELP_CATEGORIES: HelpCategory[] = [
  ...
  },
  {
    ...
    description: "Abonelik yönetimi, ödeme sorunları ve fatura bilgileri.",
    icon: "CreditCard",
    articles: [
      {
        ...
        intro:
          "Aboneliğinizi istediğiniz zaman Hesap Ayarları üzerinden kolayca iptal edebilirsiniz.",
        steps: [
          {
            title: "Hesap Ayarlarını açın",
            body: "Sağ üst köşedeki profil menüsüne tıklayın ve 'Hesap Ayarları'nı seçin.",
          },
          {
            title: "Abonelik sekmesine gidin",
            body: "Sol menüden 'Abonelik' sekmesine tıklayın.",
          },
          {
            title: "İptal Et butonuna basın",
            body: "'Aboneliği İptal Et' butonuna tıklayın.",
          },
          {
            title: "İptal nedeninizi belirtin (isteğe bağlı)",
            body: "İptal nedeninizi kısa bir anketle paylaşabilirsiniz; bu tamamen isteğe bağlıdır.",
          },
          {
            title: "Mevcut dönem sonuna kadar erişim devam eder",
            body: "İptal işlemi anında gerçekleşir ancak ödediğiniz döneme ait premium özelliklerden yararlanmaya devam edersiniz.",
          },
        ],
        keywords: ["abonelik iptal", "premium iptal", "cancel subscription", "üyelik bitir", "ücret"],
      },
      {
        slug: "payment-not-reflected",
        title: "Ödeme yansımadı",
        intro:
          "Ödeme yaptıktan sonra premium özellikler hâlâ aktif değilse aşağıdaki adımları izleyin.",
        causes: [
          "Banka onay gecikmesi",
          "Farklı bir e-posta adresiyle giriş yapılması",
          "Ödeme işlemcisinin geçici hatası",
        ],
        steps: [
          {
            title: "5-10 dakika bekleyin",
            body: "Banka onayları zaman zaman birkaç dakika sürebilir. Sayfayı yenileyip bekleyin.",
          },
          {
            title: "Doğru hesapla giriş yaptığınızı kontrol edin",
            body: "Ödeme yaptığınız e-posta adresiyle giriş yaptığınızı teyit edin.",
          },
          {
            title: "Banka ekstrenizi kontrol edin",
            body: "Bankanızın veya kart sağlayıcınızın ödemeyi onayladığını ekstrenizden doğrulayın.",
          },
          {
            title: "Abonelik durumunuzu görüntüleyin",
            body: "Hesap > Abonelik sayfasında abonelik durumunu kontrol edin.",
          },
          {
            title: "Destek ekibine başvurun",
            body: "Sorun çözülmediyse ödeme makbuzunu veya işlem numarasını ekleyerek destek ekibimizle iletişime geçin.",
          },
        ],
        keywords: ["ödeme", "payment", "fatura", "premium aktif değil", "kart", "yansımadı"],
      },
    ],
  },
  {
