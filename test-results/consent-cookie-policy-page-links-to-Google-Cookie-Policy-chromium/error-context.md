...
- Name: consent.spec.ts >> cookie policy page links to Google Cookie Policy
- Location: e2e\consent.spec.ts:328:5
...
Locator: getByRole('link', { name: 'Google Çerez Politikası' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Google Çerez Politikası' })
