...
- Name: consent.spec.ts >> cookie policy table contains all 6 registered cookies
- Location: e2e\consent.spec.ts:297:5
...
Locator: getByText('urglowup.session_token').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('urglowup.session_token').first()
