...
- Name: consent.spec.ts >> first visit — banner is visible
- Location: e2e\consent.spec.ts:44:5
...
Locator: getByRole('dialog', { name: 'Çerez Kullanımı' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Çerez Kullanımı' })
