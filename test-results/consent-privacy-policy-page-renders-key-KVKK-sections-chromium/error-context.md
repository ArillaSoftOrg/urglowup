...
- Name: consent.spec.ts >> privacy policy page renders key KVKK sections
- Location: e2e\consent.spec.ts:343:5
...
Call log:
  ...
  - waiting for locator('body')
    13 × locator resolved to <body class="flex min-h-full flex-col font-sans">…</body>
